  ...
  <vuestic-sidebar :hidden="isOpen">
    <template slot="menu">
      ...
      <sidebar-link-group>
        ...
        <sidebar-link :to="{ name: 'form-elements' }">
          <span slot="title">
            <span>{{ $t('menu.formElements') }}</span>
          </span>
        </sidebar-link>
        <sidebar-link :to="{ name: 'form-wizards' }">
          <span slot="title">
            <span>{{ $t('menu.formWizards') }}</span>
          </span>
        </sidebar-link>
        <sidebar-link :to="{ name: 'medium-editor' }">
          <span slot="title">
      ...
      <sidebar-link-group>
        ...
        <sidebar-link :to="{ name: 'typography' }">
          <span slot="title">
            <span>{{ $t('menu.typography') }}</span>
          </span>
        </sidebar-link>
        <sidebar-link :to="{ name: 'buttons' }">
          <span slot="title">
            <span>{{ $t('menu.buttons') }}</span>
          </span>
        </sidebar-link>
        <sidebar-link :to="{ name: 'color-pickers' }">
          <span slot="title">
            <span>{{ $t('menu.colorPickers') }}</span>
          </span>
        </sidebar-link>
        <sidebar-link :to="{ name: 'notifications' }">
          <span slot="title">
            <span>{{ $t('menu.notifications') }}</span>
          </span>
        </sidebar-link>
        <sidebar-link :to="{ name: 'icons' }">
          <span slot="title">
            <span>{{ $t('menu.icons') }}</span>
          </span>
        </sidebar-link>
        <sidebar-link :to="{ name: 'spinners' }">
          <span slot="title">
            <span>{{ $t('menu.spinners') }}</span>
          </span>
        </sidebar-link>
        <sidebar-link :to="{ name: 'grid' }">
          <span slot="title">
            <span>{{ $t('menu.grid') }}</span>
          </span>
        </sidebar-link>
        <sidebar-link :to="{ name: 'modals' }">
          <span slot="title">
            <span>{{ $t('menu.modals') }}</span>
          </span>
        </sidebar-link>
        <sidebar-link :to="{ name: 'file-upload' }">
          <span slot="title">
            <span>{{ $t('menu.fileUpload') }}</span>
          </span>
        </sidebar-link>
        <sidebar-link :to="{ name: 'tags' }">
          <span slot="title">
            <span>{{ $t('menu.tags') }}</span>
          </span>
        </sidebar-link>
        <sidebar-link :to="{ name: 'tree-view' }">
          <span slot="title">
      ...
      <sidebar-link-group>
        ...
        <sidebar-link :to="{ name: 'login' }" target="_blank" :isChildLink="true">
          <span slot="title">
            <span>{{ $t('menu.login') }}</span>
          </span>
        </sidebar-link>
        <sidebar-link :to="{ name: 'signup' }" target="_blank">
          <span slot="title">
      ...
      <sidebar-link-group>
        ...
        <sidebar-link :to="{ name: 'google-maps' }">
          <span slot="title">
            <span>{{ 'Google Maps' }}</span>
          </span>
        </sidebar-link>
        <sidebar-link :to="{ name: 'yandex-maps' }">
          <span slot="title">
            <span>{{ 'Yandex Maps' }}</span>
          </span>
        </sidebar-link>
        <sidebar-link :to="{ name: 'leaflet-maps' }">
          <span slot="title">
      ...
      <sidebar-link-group>
        ...
        <sidebar-link :to="{ name: '404-pages' }">
          <span slot="title">
